...
def arg_parser():
    ...
    parser.add_argument('--image', type=str, help='impage file that contains the images for prediction.',required=True)
...
def print_probability(probs, flowers):
    for i, j in enumerate(zip(flowers, probs)):
        print ("Rank {}:".format(i+1),"Flower: {}, predicted percentage: {}%".format(j[1], ceil(j[0]*100)))
